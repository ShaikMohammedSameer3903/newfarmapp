...
const AddFarmland = () => {
    ...
    useEffect(() => {
        ...
        fetch(`${process.env.REACT_APP_BACKEND_URL}/farmer/getAll`)
            .then(response => response.json())
            .then(data => setFarmers(data))
            .catch(error => console.error(error));

        // Fetch list of farmlands with no assigned NIC
        fetch(`${process.env.REACT_APP_BACKEND_URL}/farmland/noNic`)
            .then(response => response.json())
            .then(data => setFarmlands(data))
            .catch(error => console.error(error));

        fetch(`${process.env.REACT_APP_BACKEND_URL}/farmland/nic`)
            .then(response => response.json())
    ...
    const handleAddFarmland = () => {
        ...
        fetch(`${process.env.REACT_APP_BACKEND_URL}/farmland/addNew`, {
            method: 'POST',
            headers: {
    ...
    const handleAssignFarmer = () => {
        ...
        if (selectedFarmer && selectedFarmland) {
            const url = `${process.env.REACT_APP_BACKEND_URL}/farmland/updateFarmer/${selectedFarmland}/${selectedFarmer}`;
    ...
    const handleUpdateAssignFarmer = () => {
        ...
        if (selectedAssignFarmland && selectedAssignFarmer) {
            const url = `${process.env.REACT_APP_BACKEND_URL}/farmland/updateFarmer/${selectedAssignFarmland}/${selectedAssignFarmer}`;
            fetch(url, { method: 'PUT' })
                .then(response => {
                    if (response.ok) {
                        // Perform any additional actions (e.g., show success message, refresh data)
