...
const AddMachine = () => {
    ...
    useEffect(() => {
        const fetchMachineryData = async () => {
            try {
                const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/machinery/getAll`);
                if (!response.ok) {
                    throw new Error('Failed to fetch farmer data');
                }
                const data = await response.json();
    ...
    const handleAddMachine = async () => {
        try {
            const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/machinery/addNew`, {
                method: 'POST',
                headers: {
    ...
    const handleMachineUsageSubmit = () => {
        ...
        fetch(`${process.env.REACT_APP_BACKEND_URL}/machineryusage/addNew`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
