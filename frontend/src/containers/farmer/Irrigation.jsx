...
const AddIrrigationMethod = () => {
  ...
  useEffect(() => {
    const fetchFarmers = async () => {
      try {
        const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/farmer/getAll`);
        if (!response.ok) {
  ...
  useEffect(() => {
    const fetchFarmlands = async () => {
      try {
        const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/farmland/getAll/${nic}`);
        if (!response.ok) {
  ...
  useEffect(() => {
    const fetchIrrigations = async () => {
      try {
        const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/irrigation/getAll`);
        if (!response.ok) {
          throw new Error('Failed to fetch farmer data');
        }
        const data = await response.json();
  ...
  const handleAddIrrigationMethod = async () => {
    try {
      const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/irrigation/addNew`, {
        method: 'POST',
        headers: {
  ...
  const handleAssignIrrigation = async () => {
    try {
      const response = await fetch(
          `${process.env.REACT_APP_BACKEND_URL}/farmland/updateIrrigation/${selectedFarmland}/${selectedIrrigation}`,
          {
            method: 'PUT',
          }
      );
