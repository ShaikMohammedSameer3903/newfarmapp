...
export default function ReportDisease() {
    ...
    useEffect(() => {
        const fetchDiseaseData = async () => {
            try {
                const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/disease/getAll`);
                if (!response.ok) {
    ...
    const handleSubmit = () => {
        ...
        fetch(`${process.env.REACT_APP_BACKEND_URL}/disease/addNew`, {
            method: 'POST',
            headers: {
    ...
    const handleDiseaseSubmit = () => {
        ...
        // Make the POST request using fetch
        fetch(`${process.env.REACT_APP_BACKEND_URL}/hostcrop/addNew`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
