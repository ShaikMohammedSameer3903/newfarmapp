...
const FarmerHome = () => {
    ...
    useEffect(() => {
        const fetchCropedData = async () => {
            try {
                const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/farmland/croped/${nic}`);
                if (!response.ok) {
    ...
    useEffect(() => {
        const fetchUncropedData = async () => {
            try {
                const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/farmland/uncroped/${nic}`);
                if (!response.ok) {
                    throw new Error('Failed to fetch data');
                }
                const data = await response.json();
    ...
    useEffect(() => {
        const fetchCrops = async () => {
            try {
                const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/crop/getAll`);
                if (!response.ok) {
    ...
    const handleSubmit = () => {
        ...
        fetch(`${process.env.REACT_APP_BACKEND_URL}/crop/addNew`, {
            method: 'POST',
            headers: {
    ...
    const handleAssignCrop = async () => {
        ...
        try {
            const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/farmland/updateCrop/${selectedFarmland}/${selectedCrop}`, {
