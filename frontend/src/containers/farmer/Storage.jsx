...
const AddStorageMethod = () => {
    ...
    const handleSubmit = async () => {
        try {
            const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/storage/addNew`, {
                method: 'POST',
                headers: {
    ...
    useEffect(() => {
        const fetchStorageMethods = async () => {
            try {
                const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/storage/getAll`);
                if (!response.ok) {
    ...
    const handleAssignStorage = async () => {
        try {
            const response = await fetch(
                `${process.env.REACT_APP_BACKEND_URL}/farmland/updateStorage/${selectedFarmland}/${selectedStorageMethod}`,
                {
                    method: 'PUT',
                }
            );
