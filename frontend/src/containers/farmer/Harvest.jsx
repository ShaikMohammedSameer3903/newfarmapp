...
const AddHarvestMethod = () => {
    ...
    const handleSubmit = async () => {
        try {
            const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/harvest/addNew`, {
                method: 'POST',
                headers: {
    ...
    useEffect(() => {
        const fetchHarvestMethods = async () => {
            try {
                const response = await fetch(`${process.env.REACT_APP_BACKEND_URL}/harvest/getAll`);
                if (!response.ok) {
    ...
    const handleAssignHarvest = async () => {
        try {
            const response = await fetch(
                `${process.env.REACT_APP_BACKEND_URL}/farmland/updateHarvest/${selectedFarmland}/${selectedHarvestMethod}`,
                {
                    method: 'PUT',
                }
            );
