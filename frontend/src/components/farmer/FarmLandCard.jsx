...
function FarmLandCard({
    ...
    const handleViewPlantClick = async () => {
        try {
            ...
            const plantResponse = await fetch(`${process.env.REACT_APP_BACKEND_URL}/crop/getbyID/${cropID}`);
    ...
    const handleViewSoilClick = () => {
        fetch(`${process.env.REACT_APP_BACKEND_URL}/soil/getDetails/${farmlandID}`)
    ...
    const handleViewWeatherClick = () => {
        fetch(`${process.env.REACT_APP_BACKEND_URL}/weather/getDetails/${farmlandID}`)
            .then((response) => response.json())
            .then((data) => {
    ...
    const handleViewDiseaseClick = () => {
        fetch(`${process.env.REACT_APP_BACKEND_URL}/hostcrop/getDisease/${farmlandID}`)
            .then((response) => response.json())
            .then((data) => {
                setDiseaseData(data);
    ...
    const handleViewChemicalClick = () => {
        fetch(`${process.env.REACT_APP_BACKEND_URL}/chemicalusage/getChemical/${farmlandID}`)
            .then((response) => response.json())
            .then((data) => {
    ...
    const handleViewMachineryClick = () => {
        fetch(`${process.env.REACT_APP_BACKEND_URL}/machineryusage/getMachinery/${farmlandID}`)
            .then((response) => response.json())
            .then((data) => {
